...
class CardOnBoardingLinkViewHolder(
    ...
    init {
        ...
        cardOnBoardLinkAdapter.setPlansData(membershipPlans.filter {
            it.isPlanPLL() && it.feature_set?.linking_support?.contains(
                LINKING_SUPPORT_ADD
            ) == true || it.feature_set?.linking_support?.contains(LINKING_SUPPORT_ENROL) == true
