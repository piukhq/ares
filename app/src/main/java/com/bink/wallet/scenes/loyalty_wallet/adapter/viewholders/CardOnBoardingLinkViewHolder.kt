...
import com.bink.wallet.scenes.loyalty_wallet.CardOnboardLinkAdapter
...
class CardOnBoardingLinkViewHolder(
    ...
    init {
        ...
        cardOnBoardLinkAdapter.setPlansData(membershipPlans.filter { it.isPlanPLL() }.sortedByDescending { it.id }.take(state))
