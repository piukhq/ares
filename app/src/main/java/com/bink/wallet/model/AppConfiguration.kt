...
data class BetaFeature(val slug: String, val type: String, val title: String, val description: String, val enabled: Boolean, var enabledMerchants: List<String>, var locallyEnabled: Boolean = false)
