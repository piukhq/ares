    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel.paymentCard.observeNonNull(this) { paymentCard ->
            ...
            if (paymentCard.card?.provider != null && paymentCard.status != null){
                logEvent(ADD_PAYMENT_CARD_RESPONSE_SUCCESS,getAddPaymentCardResponseSuccessMap(paymentCard.uuid?:"", paymentCard.card.provider,accountIsNew,paymentCard.status))
            }
        }
